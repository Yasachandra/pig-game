...
// Set active player's current round score to 0 and change the active player
function nextPlayer() {
    activePlayer = activePlayer === 0 ? 1 : 0;
    document.getElementById("current-0").textContent = 0;
    document.getElementById("current-1").textContent = 0;
    // toggle method toggles the given class i.e. if it is not there then it adds it otherwise removes it
